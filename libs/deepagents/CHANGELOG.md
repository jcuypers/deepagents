...
## [0.6.3](https://github.com/jcuypers/deepagents/compare/deepagents==0.6.2...deepagents==0.6.3) (2026-05-19)


### Features

* **quickjs:** rename middleware ([#3334](https://github.com/jcuypers/deepagents/issues/3334)) ([fc80075](https://github.com/jcuypers/deepagents/commit/fc80075c65c3b4beb8f672b6bb27464fee6d79c2))
...
* **sdk:** add `ContextHubBackend` backend type ([#3338](https://github.com/jcuypers/deepagents/issues/3338)) ([6962826](https://github.com/jcuypers/deepagents/commit/69628263cb2c1f6951b1b37bbc0edbb85983ad51))
* **sdk:** add `system_prompt` override slot to memory, skills, and summarization ([#3451](https://github.com/jcuypers/deepagents/issues/3451)) ([7583f4a](https://github.com/jcuypers/deepagents/commit/7583f4aff6a6044bc987ee7980d322bb5c791428))
...
* **sdk:** align `MemoryMiddleware` prompt with investigate-first agent behavior ([#2461](https://github.com/jcuypers/deepagents/issues/2461)) ([d53c8f4](https://github.com/jcuypers/deepagents/commit/d53c8f4f481288a3aa04a5e62362beba6ed7e57a))
* **sdk:** auto-added GP subagent inherits parent permissions ([#3131](https://github.com/jcuypers/deepagents/issues/3131)) ([0d55b3b](https://github.com/jcuypers/deepagents/commit/0d55b3ba8b974d06b1e0f52893f33e44496bff8b))
* **sdk:** avoid deprecated-use warnings in `CompositeBackend` path mutation ([#3244](https://github.com/jcuypers/deepagents/issues/3244)) ([64d45f6](https://github.com/jcuypers/deepagents/commit/64d45f67c86edb4df2ced0e7b82f1a8fd158ec8c))
* **sdk:** clarify skill source labels in system prompt ([#3464](https://github.com/jcuypers/deepagents/issues/3464)) ([fc6a24f](https://github.com/jcuypers/deepagents/commit/fc6a24f18829cf3f36089945226edfa50d52ab9e))
...
* **sdk:** import profile re-exports from leaf modules ([#3377](https://github.com/jcuypers/deepagents/issues/3377)) ([ca99391](https://github.com/jcuypers/deepagents/commit/ca99391668ea1510932f8e9097e8ed3c0caadf73))
* **sdk:** import profile symbols directly from `harness_profiles` ([#3291](https://github.com/jcuypers/deepagents/issues/3291)) ([503453c](https://github.com/jcuypers/deepagents/commit/503453c06f7e0545914789a07ddba6ca6b0c8ec5))
...
* **sdk:** patch invalid tool calls ([#3386](https://github.com/jcuypers/deepagents/issues/3386)) ([c916d1b](https://github.com/jcuypers/deepagents/commit/c916d1b2e3a81dcd4fb2e595d6b971923c18fa31))
...
* **sdk:** strip HTML comments from memory content before system prompt injection ([#3462](https://github.com/jcuypers/deepagents/issues/3462)) ([bfbb8bc](https://github.com/jcuypers/deepagents/commit/bfbb8bc5575ebd1ba9aa29430f6d2f86c24b7d3c))
* **sdk:** subagents: update prompt and make fetching of last message more robust ([#3406](https://github.com/jcuypers/deepagents/issues/3406)) ([4421bec](https://github.com/jcuypers/deepagents/commit/4421bec94ffbe1f3a3bf44088ebcf8ab8c24a736))
* **sdk:** summarization: truncate trailing ToolMessages to keep context within `keep` limit ([#3405](https://github.com/jcuypers/deepagents/issues/3405)) ([bee514f](https://github.com/jcuypers/deepagents/commit/bee514fd24862b6b22a5993eb8b6cfc69e42dd80))
...
* **sdk:** surface OS errors in sandbox ls/read/edit/glob ([#3359](https://github.com/jcuypers/deepagents/issues/3359)) ([7598bd9](https://github.com/jcuypers/deepagents/commit/7598bd93f72b609a46da64f7c458c42ac07a0f3a))
