...
## [0.0.49](https://github.com/jcuypers/deepagents/compare/deepagents-cli==0.0.48...deepagents-cli==0.0.49) (2026-05-03)
...
* **cli:** `--skill` startup invocation ([#2477](https://github.com/jcuypers/deepagents/issues/2477)) ([5f0f1d4](https://github.com/jcuypers/deepagents/commit/5f0f1d4605de1f1545846e2dbcc29a24c6f138d7))
...
* **cli:** `/auto-update` to toggle auto-updates ([#2276](https://github.com/jcuypers/deepagents/issues/2276)) ([ad70bde](https://github.com/jcuypers/deepagents/commit/ad70bde070c58057ff98871fcacd95f03487051e))
...
* **cli:** `deepagents deploy` ([#2491](https://github.com/jcuypers/deepagents/issues/2491)) ([01dc60e](https://github.com/jcuypers/deepagents/commit/01dc60e394ecb56bd5336e447d32caeed8a67ec2))
...
* **cli:** add `DEEPAGENTS_CLI_` env var prefix and fix dotenv load order ([#2303](https://github.com/jcuypers/deepagents/issues/2303)) ([29647bb](https://github.com/jcuypers/deepagents/commit/29647bb4cdd89a1de65f6adb518f708135d59e03))
* **cli:** add `ls_integration` metadata to langsmith traces ([#2272](https://github.com/jcuypers/deepagents/issues/2272)) ([5dd8098](https://github.com/jcuypers/deepagents/commit/5dd80983a57a5c48bb9c75c6760733882cb908c2))
...
* **cli:** agent-friendly ux for scripted/headless workflows ([#2271](https://github.com/jcuypers/deepagents/issues/2271)) ([386438f](https://github.com/jcuypers/deepagents/commit/386438f62a458baa367468cf746c3a5387a217d4))
* **cli:** allow color overrides on built-in themes, default dark to false ([#2275](https://github.com/jcuypers/deepagents/issues/2275)) ([8f71865](https://github.com/jcuypers/deepagents/commit/8f718650ee1913f83e70aa7854e576edc816e694))
...
* **cli:** default langsmith project to `'deepagents-cli'` ([#2277](https://github.com/jcuypers/deepagents/issues/2277)) ([7178b87](https://github.com/jcuypers/deepagents/commit/7178b8729a03ee1e5508fdf6c111488d18e77e8f))
...
* **cli:** load `~/.deepagents/.env` as global dotenv ([#1909](https://github.com/jcuypers/deepagents/issues/1909)) ([5a21d0a](https://github.com/jcuypers/deepagents/commit/5a21d0add1d2a885c6cd3cf36621d1da690c8db3))
* **cli:** persist token count in graph state across sessions ([#2323](https://github.com/jcuypers/deepagents/issues/2323)) ([5be352d](https://github.com/jcuypers/deepagents/commit/5be352d8bb4d266758f3e934f7affbe8d42b0149))
...
* **cli:** render ask-user questions as markdown ([#2339](https://github.com/jcuypers/deepagents/issues/2339)) ([5fbb14a](https://github.com/jcuypers/deepagents/commit/5fbb14a4fd6f2800aec99add1d9f32b88c1d751a))
...
* **cli:** support root/MDM installs ([#2346](https://github.com/jcuypers/deepagents/issues/2346)) ([f618acc](https://github.com/jcuypers/deepagents/commit/f618acc671ca2137df165d6f56e8a46f11c63abb))
* **cli:** surface unsupported input modalities in system prompt ([#2327](https://github.com/jcuypers/deepagents/issues/2327)) ([95620e7](https://github.com/jcuypers/deepagents/commit/95620e796aa6bf11f424d2f83693026fbee6be58))
...
* **cli:** warn on missing tavily key, add `/notifications` ([#2555](https://github.com/jcuypers/deepagents/issues/2555)) ([3dff3ed](https://github.com/jcuypers/deepagents/commit/3dff3ed6835eae9f8b420b8a73c054127faaf7d2))
...
* **cli:** align headless todo guidance with non-interactive mode ([#2459](https://github.com/jcuypers/deepagents/issues/2459)) ([281899b](https://github.com/jcuypers/deepagents/commit/281899bf1932f959f512f94f4c2ac5d76ad32ecb))
...
* **cli:** disable markup parsing for blocked-link notifications ([#2170](https://github.com/jcuypers/deepagents/issues/2170)) ([15867bf](https://github.com/jcuypers/deepagents/commit/15867bfaeb43b5fca31677fd06b25022aec10c8b))
* **cli:** dismiss slash command autocomplete on space ([#2478](https://github.com/jcuypers/deepagents/issues/2478)) ([02e46bc](https://github.com/jcuypers/deepagents/commit/02e46bc4cc470d93f5ab3ca05252ef1ffe87c3e7))
* **cli:** eliminate trace fragmentation in non-interactive mode ([#2136](https://github.com/jcuypers/deepagents/issues/2136)) ([9bddc52](https://github.com/jcuypers/deepagents/commit/9bddc52b572672e0564bfc4a8675e106d98116af))
* **cli:** enforce approval toggle when launched with `-y` ([#2278](https://github.com/jcuypers/deepagents/issues/2278)) ([28a32b7](https://github.com/jcuypers/deepagents/commit/28a32b7dfb6fd6ddb9aa443a9d0d70c33790edbd))
* **cli:** escape exception text in rich markup error output ([#2307](https://github.com/jcuypers/deepagents/issues/2307)) ([42bccca](https://github.com/jcuypers/deepagents/commit/42bccca05f1733a04ee21da6bf9924140f6e1e65))
* **cli:** exit app on `ctrl+d` when thread list is empty ([#2270](https://github.com/jcuypers/deepagents/issues/2270)) ([e859077](https://github.com/jcuypers/deepagents/commit/e859077ffa7ee0423bbc7b86d5a4238798ec9c9a))
* **cli:** fail fast on missing provider credentials ([#2554](https://github.com/jcuypers/deepagents/issues/2554)) ([50fb8ae](https://github.com/jcuypers/deepagents/commit/50fb8aefe7e3065024e10f1d5ecd11a54d736641))
* **cli:** fix mktemp template in debug script for macOS ([#2603](https://github.com/jcuypers/deepagents/issues/2603)) ([63fa537](https://github.com/jcuypers/deepagents/commit/63fa537e9995ca2ead492ee44902227567e9a130))
...
* **cli:** guard against textual cursor/document desync crash ([#2494](https://github.com/jcuypers/deepagents/issues/2494)) ([c14a748](https://github.com/jcuypers/deepagents/commit/c14a7483ed92428ec2241dd8254cdab9c26a6a4f))
...
* **cli:** mark token count as approximate after interrupted generation ([#2353](https://github.com/jcuypers/deepagents/issues/2353)) ([cb9a0c7](https://github.com/jcuypers/deepagents/commit/cb9a0c7ad2f9421471b4276a33beabc30588b694))
...
* **cli:** open trace in browser immediately when busy ([#2305](https://github.com/jcuypers/deepagents/issues/2305)) ([b452032](https://github.com/jcuypers/deepagents/commit/b452032438f83e0cca245dcabacf176cc1aa8857))
...
* **cli:** prevent session stats loss on mid-turn exit ([#2238](https://github.com/jcuypers/deepagents/issues/2238)) ([b1807aa](https://github.com/jcuypers/deepagents/commit/b1807aab78175c53a2d6f835ae30171d0f802d1c))
...
* **cli:** resolve conflicting langsmith env var precedence ([#2455](https://github.com/jcuypers/deepagents/issues/2455)) ([b6997d8](https://github.com/jcuypers/deepagents/commit/b6997d830c8c2822acbaa0ad672bdec873af2b9d))
...
* **cli:** show server startup error instead of generic agent message ([#2397](https://github.com/jcuypers/deepagents/issues/2397)) ([a3e1e93](https://github.com/jcuypers/deepagents/commit/a3e1e9365178ad14d7233ae577bb87d714daff5c))
* **cli:** sort MCP tools deterministically for prompt-cache stability ([#2497](https://github.com/jcuypers/deepagents/issues/2497)) ([39b43cf](https://github.com/jcuypers/deepagents/commit/39b43cf8d0f44827f3b2faf32843c7db436539e8))
...
* **cli:** stop loading widget timer leak ([#2396](https://github.com/jcuypers/deepagents/issues/2396)) ([01d3d86](https://github.com/jcuypers/deepagents/commit/01d3d864098c4e96527082b2bd1755ac6591b098))
...
* **cli:** use relative paths in langgraph config for Windows compat ([#2244](https://github.com/jcuypers/deepagents/issues/2244)) ([d10dfbd](https://github.com/jcuypers/deepagents/commit/d10dfbd7d8ff18653d0d25197c76c8b379f60bf0))
* **cli:** warn agent that local filesystem is inaccessible in sandbox mode ([#2274](https://github.com/jcuypers/deepagents/issues/2274)) ([a3b61e5](https://github.com/jcuypers/deepagents/commit/a3b61e5d57fcf240fec4afa7734a5c864bdcd886))
...
* **cli:** defer `/model` selector data loading off event loop ([#2259](https://github.com/jcuypers/deepagents/issues/2259)) ([a32ce7f](https://github.com/jcuypers/deepagents/commit/a32ce7ff6b2112cf48170d2279a1953eded61987))
* **cli:** defer pydantic and adapter imports out of startup hot path ([#2269](https://github.com/jcuypers/deepagents/issues/2269)) ([0a410b4](https://github.com/jcuypers/deepagents/commit/0a410b4aba729a71c78e7fd470c904d95fea171a))
* **cli:** prewarm markdown stack and cache skill body render ([#2236](https://github.com/jcuypers/deepagents/issues/2236)) ([0a3ba47](https://github.com/jcuypers/deepagents/commit/0a3ba47615bfdaba1a51dbff1c75c392dd87579e))
* **cli:** reduce health poll interval for local langgraph dev server ([#2283](https://github.com/jcuypers/deepagents/issues/2283)) ([7f5c3de](https://github.com/jcuypers/deepagents/commit/7f5c3de9cf5501abc24fbaf50152c4c625b04f1b))
